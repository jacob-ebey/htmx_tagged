...
export async function loader({ context: { docs } }: LoaderArgs<Context>) {
...
export default function Layout(props: RouteProps<typeof loader>) {
  return html`
    ${Header(props)}
